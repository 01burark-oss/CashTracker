...
namespace CashTracker.App
{
    ...
    internal static class AppLocalization
    {
        ...
        private static readonly Dictionary<string, Entry> Texts = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["main.footer.credit"] = new("CashTracker", "CashTracker", "CashTracker"),
            ...
            ["main.update.startedBody"] = new("Guncelleme paketi calistirildi. Kurulumdan sonra uygulamayi yeniden ac.\nMasaustundeki exe guncellenecek.", "Update package was launched. Reopen the app after installation.\nDesktop exe will be updated.", "Update-Paket wurde gestartet. Oeffnen Sie die App nach der Installation erneut.\nDesktop-exe wird aktualisiert."),
            ...
            ["pin.info"] = new("4 haneli sifrenizi girin. Varsayilan sifre: 0000", "Enter your 4-digit password. Default password: 0000", "Geben Sie Ihr 4-stelliges Passwort ein. Standardpasswort: 0000"),
            ...
            ["pin.forgot.title"] = new("Sifre Hatirlatma", "Password Reminder", "Passwort-Erinnerung"),
            ["pin.forgot.telegramNotConfigured"] = new("Telegram ayarlari eksik. Once bot ayarlarini tamamlayin.", "Telegram settings are missing. Complete bot settings first.", "Telegram-Einstellungen fehlen. Schliessen Sie zuerst die Bot-Einstellungen ab."),
            ["pin.forgot.confirm"] = new("Mevcut sifre Telegram'a gonderilsin mi?", "Send current password to Telegram?", "Aktuelles Passwort an Telegram senden?"),
            ["pin.forgot.messageToTelegram"] = new("CashTracker sifre hatirlatma\nPIN: {0}\nTarih: {1}", "CashTracker password reminder\nPIN: {0}\nDate: {1}", "CashTracker Passwort-Erinnerung\nPIN: {0}\nDatum: {1}"),
            ["pin.forgot.sent"] = new("Sifre Telegram'a gonderildi.", "Password was sent to Telegram.", "Passwort wurde an Telegram gesendet."),
            ["pin.forgot.sendError"] = new("Sifre gonderilemedi: {0}", "Password could not be sent: {0}", "Passwort konnte nicht gesendet werden: {0}"),
